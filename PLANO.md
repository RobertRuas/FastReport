...
- Seguir **Human Interface Guidelines** de macOS: barra de ferramentas nativa, tipografia SF, materiais (sidebar / background), espaçamento 8 pt. Chrome: `FastReport/App/AppCommands.swift` e toolbars nas views de `Features/`.
